...
export default function Home() {
    return (
        <div className="w-full px-6">
            <div className="mt-14 md:mt-[163px] w-full md:pl-[186px] md:pr-[100px] flex items-start gap-[98px]">
                <div className="flex flex-col md:block items-center">
                    ...
                    <div className="mt-20 md:mt-[146px] flex gap-8 md:gap-[48px]">
            ...
            <div className="mt-24 md:mt-[150px] md:px-[106px]">
                <h1 className="heading-primary text-[36px] md:text-[52px] text-center">Practice Tests</h1>
                <div className="mt-0 md:mt-[42px] w-full flex flex-col items-center md:flex-row flex-wrap justify-center gap-[32px]">
            ...
            <div className="mt-8 md:mt-[64px] md:px-[106px]">
                <h1 className="heading-primary text-[36px] md:text-[52px] text-center">Features</h1>
                <div className="mt-2 md:mt-[42px] w-full flex flex-col justify-center gap-[32px] text-center md:text-left">
                    {FeaturesContent.map((content, index) => (
                        <div key={`feature-${index}`} className={`flex flex-col items-center md:items-start ${(index + 1) % 2 === 0 ? "md:flex-row-reverse" : "md:flex-row"} items-start justify-between`}>
                            <div className="max-w-[854px]">
                                <h1 className="heading-tertiary">{content.heading}</h1>
                                <p className="font-[300] text-[20px] md:text-[24px] leading-[36px]">{content.description}</p>
                            </div>
                            <Image
                                src={content.img}
                                height={276}
