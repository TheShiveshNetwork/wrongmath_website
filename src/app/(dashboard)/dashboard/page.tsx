    ...
    return (
        <div className="w-full">
            ...
            <div className="mt-[24px] flex flex-col box-shadow h-auto p-[42px_42px_33px_20px] rounded-[24px] w-full">
                <h1 className="text-[30px] font-[700] text-primary leading-[45px] text-center mb-[35px]">Overall Performance</h1>
                <LineGraph />
            </div>
            <div className="flex flex-row md:flex-col gap-6">
                <div className="mt-[24px] py-6 min-h-[158px] flex flex-col md:flex-row box-shadow w-full items-center justify-center gap-[42px] rounded-[24px]">
                    ...
                    <div className="w-[110px] h-[2px] md:h-[110px] md:w-[2px] bg-[#BAD6EB]" />
                    <div className="text-[16px] md:text-[24px] h-[110px] font-[400] leading-[36px] -tracking-[0.02em] text-center">
                        <span className=" text-[rgba(52,78,173,1)]">Physics</span> <br />
                        <span className="text-primary font-[600] text-[32px] md:text-[44px] leading-[66px]">24/20</span>
                    </div>
                    <div className="w-[110px] h-[2px] md:h-[110px] md:w-[2px] bg-[#BAD6EB]" />
                    <div className="text-[16px] md:text-[24px] h-[110px] font-[400] leading-[36px] -tracking-[0.02em] text-center">
                        <span className=" text-[rgba(52,78,173,1)]">Chemistry</span> <br />
                        <span className="text-primary font-[600] text-[32px] md:text-[44px] leading-[66px]">10/20</span>
                    </div>
                    <div className="w-[110px] h-[2px] md:h-[110px] md:w-[2px] bg-[#BAD6EB]" />
                    <div className="text-[16px] md:text-[24px] h-[110px] font-[400] leading-[36px] -tracking-[0.02em] text-center">
                        <span className=" text-[rgba(52,78,173,1)]">Mathematics</span> <br />
                        <span className="text-primary font-[600] text-[32px] md:text-[44px] leading-[66px]">45/20</span>
                    </div>
                </div>
                <div className="mt-[24px] flex flex-col md:flex-row gap-[24px] w-full">
                    <div className="box-shadow md:w-1/4 h-[170px] w-full md:min-w-[238px] flex flex-col gap-[16px] items-center justify-center text-center">
